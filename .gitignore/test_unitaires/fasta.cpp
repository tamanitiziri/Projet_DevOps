/*compiler: g++ -std=c++20 -o fasta fasta.cpp FastaParser.cpp SequenceParser.cpp FastqFileReader.cpp FormatFileDetector.cpp
 *execute: ./fasta
 *veuillez verifier que le fichier test1.fasta, test2.fasta, test4.fasta, test5.fasta et test6.fasta existent dans le meme dossier que le code
 *Ce code est un exemple de test pour la classe FastaParser
  */
