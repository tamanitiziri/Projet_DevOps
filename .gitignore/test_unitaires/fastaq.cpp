/* ce fichier est consus pour tester la classe FastaParser
 * il utilise la classe FastaParser pour parser un fichier FASTA et valider son contenu
 *pour compiler: g++ -std=c++20 fastaq.cpp FastaParser.cpp FastqFileReader.cpp FormatFileDetector.cpp SequenceParser.cpp -o fasta_parser_tester
 *pour executer: ./fasta_parser_tester
 * * Ce code est un exemple de test pour la classe FastqFileReader et FastaParser
 * Il génère des fichiers FASTQ de test, puis les teste avec le bon parser.
 *
*/
